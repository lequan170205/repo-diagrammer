---
name: diagram
description: Force the full evidence-IR repo-diagram workflow for one requested architecture, sequence, class, ER, state, dataflow, deployment, call graph, use case, flowchart, or swimlane diagram.
---

# Diagram

1. Read `../repo-diagram/SKILL.md` completely.
2. Apply that workflow to the current request.
